      ...
      <div className={styles.svg}>
        ...
        <div className={styles.custodial}>
          <p>
            ...
            Stacks Ӿ blockchain for trustless contributions & reward redemption.
          </p>
        </div>
        <div className={`${styles.two}`}>
          ...
          <p>
            Sypool is <span>partially</span> trustless. While you have to trust
            your funds aren’t misused, any contributions will always be
            redeemable through the smart contract.
          </p>
          <p>
            Meaning the only trust in Sypool is that we are reputable and only
            mine STX with contributed funds. Of which we strive to be, and will
            do.
          </p>
        </div>
        ...
        <div className={styles.three}>
          ...
          <p className={styles.strength}>strength in numbers, trust in none</p>
          <p className={styles.built}>
            Sypool is built by Syvita Guild, a decentralised guild (we’re a
            DAO). Arguably the largest entity in the Stacks ecosystem by member
            & project count, we are behind some of the largest projects on
            Stacks.
          </p>
        ...
        <div className={styles.four}>
          ...
          <p>
            We’re pretty annoyed (putting it nicely) with unfair and unnecessary
            regulations on the legacy banking system. It’s why we’re building on
            Bitcoin with Stacks. So all of our projects are designed
            privacy-first and dunked in the finest cryptographically-ensured
            security dip.
          </p>
