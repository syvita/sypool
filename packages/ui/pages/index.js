...
export default function Home() {
  ...
  const HomePage = () => {
    return (
      <main
        className={
          (styles.body, theme === "light" ? styles.light : styles.dark)
        }
      >
        <div className={styles.body}>
          ...
          <div className={styles.svg}>
            ...
            <div className={styles.custodial}>
              <p>
                Sypool is a custodial STX mining pool using smart contracts on
                the Stacks Ӿ blockchain for trustless contributions & reward
                redemption.
              </p>
            </div>
            <div className={`${styles.two}`}>
              ...
              <p>
                ...
                Stacks. This means when people contribute with Bitcoin to our
                pool address, we can verify this happened through a trustless
                smart contract.
              </p>

              <p>
                Sypool is <span>partially</span> trustless. While you have to
                trust your funds aren’t misused, any contributions will always
                be redeemable through the smart contract.
              </p>
              <p>
                Meaning the only trust in Sypool is that we are reputable and
                only mine STX with contributed funds. Of which we strive to be,
                and will do.
              </p>
            </div>
            ...
            <div className={styles.three}>
              ...
              <p className={styles.built}>
                ...
                member & project count, we are behind some of the largest
                projects on Stacks.
              </p>

              <p className={styles.quote}>
                “Syvita is probably the biggest decentralised entity in the
                Stacks ecosystem. They’re building a new world.”
              </p>
          ...
          <div className={styles.bannerfour}>
            ...
            <div className={styles.four}>
              ...
              <p>
                ...
                we’re building on Bitcoin with Stacks. So all of our projects
                are designed privacy-first and dunked in the finest
              ...
              <p>
                Data minimalisation, no central databases and dummy-thicc
                privacy walls allow us to run Sypool without even knowing who
                you are. Plainly, we don’t care either. And that’s a good thing.
                We believe in extreme equality, so why should we have any data
                to personally identify you in the first place? No reason. So we
                don’t.
              </p>
            </div>
            <div>
  ...
  return userSession.isUserSignedIn() ? <Dashboard /> : <HomePage />;
}
